...
class WhatIfSimulator(QWidget):
    ...
    def _build_ui(self):
        ...
        sl.addWidget(QLabel(
            "<span style='color:#A8B4C8;font-size:8pt;'>Step Sim:</span>"))
        ...
        # Step count
        sl.addWidget(QLabel(
            "<span style='color:#A8B4C8;font-size:8pt;'>Steps:</span>"))
        ...
        # Speed
        sl.addWidget(QLabel(
            "<span style='color:#A8B4C8;font-size:8pt;'>Speed:</span>"))
        ...
        self._noise_chk.setStyleSheet(
            "QCheckBox { color: #A8B4C8; font-size: 8pt; spacing: 4px; }"
    ...
    def _install_mv_opt_combo(self, row: int, mv):
        ...
        combo.setStyleSheet(
            ...
            "background: #FFF8E8; border: 1px solid #C0C8D8; }")
    ...
    def _build_plots(self):
        ...
        for i, cv in enumerate(self.cfg.cvs):
            ...
            pw.setTitle(cv.name, size="9pt", color="#1A2744")
        ...
        for i, mv in enumerate(self.cfg.mvs):
            ...
            pw.setTitle(mv.name, size="9pt", color="#1A2744")
